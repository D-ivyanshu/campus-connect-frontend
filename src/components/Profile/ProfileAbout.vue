<template>
  <div class="mt-10 w-full">
    <!--TODO: {{ Improve the border part }} -->
    <!-- <div class="grid grid-cols-4 grid-rows-5 gap-4">
      <div
        class="bg-red-300 row-span-2 shadow-lg rounded-lg flex flex-col md:flex-row items-center justify-evenly border-[1px] border-slate-100"
      >
        <div class="lg:mr-2 items-center justify-center flex flex-col">
        ...
        <div class="lg:ml-2 items-center justify-center flex flex-col">
          <div class="text-xl font-semibold">{{ User?.attributes?.following_count }}</div>
          <div class="text-sm text-slate-500">Following</div>
        </div>
      </div>
      <div
        class="col-span-3 row-span-5 shadow-lg rounded-lg border-[1px] border-slate-100 p-5 bg-green-100"
      >
        <ShareSomething />
        ...
        <div class="mt-2">
          <div class="pl-5 text-sm mt-3">{{ course }}</div>
          <div class="pl-5 text-sm mt-3">
            <button
      ...
      <div
        class="row-span-3 row-start-3 shadow-lg rounded-lg border-[1px] border-slate-100 flex flex-col"
      >
        <h1 class="pl-3 pt-3 text-lg font-semibold">Social</h1>
          ...
          <ul class="p-3">
            <li class="flex items-center">
              <svg
                ...
                aria-hidden="true"
                role="img"
                class="text-blue-500 mr-2 h-5 w-5"
                viewBox="0 0 24 24"
              >
                <path
                  fill="currentColor"
              ...
              <a :href="socialMedia?.facebook" class="hover:text-blue-500 cursor-pointer"
                ><span class="hidden lg:block">Facebook</span></a
              >
            </li>
            <li class="flex items-center">
              <svg
                ...
                aria-hidden="true"
                role="img"
                class="text-pink-600 mr-3 h-4 w-4"
              ...
              <a :href="socialMedia?.instagram" class="hover:text-pink-600 cursor-pointer"
              ><span class="hidden lg:block">Instagram</span></a
              >
            </li>
            <li class="flex items-center">
              <svg
              ...
              aria-hidden="true"
              role="img"
                class="text-blue-600 mr-2 h-5 w-5"
                viewBox="0 0 24 24"
                >
                <path
                fill="currentColor"
              ...
              <a :href="socialMedia?.linkedin" class="hover:text-blue-600 cursor-pointer"
                ><span class="hidden lg:block">Linkedin</span></a
              >
            </li>
            <li class="flex items-center">
              <svg
                ...
                aria-hidden="true"
                role="img"
                class="text-blue-400 mr-2 h-5 w-5"
                width="1em"
                height="1em"
                viewBox="0 0 24 24"
              >
              ...
              <a :href="socialMedia?.twitter" class="hover:text-blue-400 cursor-pointer"
              ><span class="hidden lg:block">Twitter</span></a
              >
            </li>
          </ul>
        </div>
    ...
    <div class="grid gap-5 w-full">
      <div class="grid grid-cols-6 gap-6">
          ...
          <div class="relative">
            ...
            >
              <div class="rounded-xl flex flex-col md:flex-row items-center justify-evenly">
                <div class="lg:mr-2 items-center justify-center flex flex-col hover:scale-110">
                  <div class="text-xl font-semibold">{{ User?.attributes?.followers_count }}</div>
                  <div class="text-sm text-slate-500">Followers</div>
                </div>
                ...
                <div class="lg:ml-2 items-center justify-center flex flex-col hover:scale-110">
                  <div class="text-xl font-semibold">{{ User?.attributes?.following_count }}</div>
                  <div class="text-sm text-slate-500">Following</div>
                </div>
              </div>
          ...
          <div class="flex items-center justify-center mt-5 rounded-xl p-3 shadow-lg border-[1px]">
            <div class="hidden md:block">
              <ul class="flex items-center justify-center">
                <!-- Facebook -->
                <li class="flex items-center">
                  <a href="/" class="hover:text-blue-500 cursor-pointer">
                    <TooltipProvider>
                      <Tooltip>
                        <TooltipTrigger>
                          <IconFacebook />
        ...
        <div class="col-span-4">
            ...
            >
              <ul class="">
                ...
                <li class="flex items-center mt-3">
                  ...
                  <span class="ml-1">divyanshu.20224@knit.ac.in</span>
                </li>
                <li class="flex mt-3">
                  <svg
                    xmlns="http://www.w3.org/2000/svg"
                ...
                <li class="flex mt-3">
                  ...
                  <span class="ml-1">{{ year }} year</span>
                </li>
                <li class="flex mt-3">
                  <svg
                    xmlns="http://www.w3.org/2000/svg"
          ...
          <!-- <div class="rounded-xl shadow-lg border-[1px]">
            <ul class="p-8">
              <li class="text-md">
                Tart I love sugar plum I love oat cake. Sweet roll caramels I love jujubes. Topping
                cake wafer..
              </li>
